...
<body>
    <center>
        ...
        <br>
        <h1>MUAY THAI</h1>
        <img src="muaythai.png" alt="Muay Thai">
        ...
        <br>
        <h1>TAE KWON DO</h1>
        <img src="TKD.png" alt="Tae Kwon Do">
       ...
       <img src="BOXING.png" alt="Boxing">
        ...
        <br>
        <h1>KICK BOXING</h1>
        <img src="Kickboxing.png" alt="Kickboxing">
        ...
        <br>
        <h1>GRAPPLING</h1>
       <img src="grappling.png" alt="Grappling">
        ...
        <br>
        <h1>WRESTLING</h1>
        <img src="wrestling.png" alt="Wrestling">
