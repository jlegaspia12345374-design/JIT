...
<body>
    <center>
        ...
        <br>
        <h1>MUAY THAI</h1>
        <img src="{{ url_for('static', filename='muaythai.png') }}">
        ...
        <br>
        <h1>KARATE</h1>
        <img src="{{ url_for('static', filename='karate.png') }}">
        ...
        <br>
        <h1>JIU-JITSU</h1>
        <img src="{{ url_for('static', filename='JJT.png') }}">
        ...
        <br>
        <h1>TAE KWON DO</h1>
        <img src="{{ url_for('static', filename='TKD.png') }}">
        ...
        <br>
        <h1>BOXING</h1>
        <img src="{{ url_for('static', filename='BOXING.png') }}">
        ...
        <br>
        <h1>KICK BOXING</h1>
        <img src="{{ url_for('static', filename='Kickboxing.png') }}">
        ...
        <br>
        <h1>GRAPPLING</h1>
        <img src="{{ url_for('static', filename='grappling.png') }}">
        ...
        <br>
        <h1>WRESTLING</h1>
        <img src="{{ url_for('static', filename='wrestling.png') }}">
